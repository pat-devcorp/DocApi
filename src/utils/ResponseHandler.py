...
DB_CONNECTION_ERROR = ResponseDTO("1000", "Databse server does not respond")
DB_COLLECTION_NOT_FOUND = ResponseDTO("1000", "Databse server does not respond")
DB_GET_FAIL = ResponseDTO("1000", "Databse server does not respond")
DB_CREATE_FAIL = ResponseDTO("1000", "Databse server does not respond")
DB_UPDATE_FAIL = ResponseDTO("1000", "Databse server does not respond")
DB_DELETE_FAIL = ResponseDTO("1000", "Databse server does not respond")
PRESENTATION_VALIDATION = ResponseDTO("1000", "Databse server does not respond")
